...
namespace Nerdbank.Streams.Tests.SequenceReader
{
    public class BinaryExtensions
    {
        ...
        public void MultiSegmentBytesReaderNumbers()
        {
            ...
            reader.TryReadExact(4, out _);
            ////Assert.True(reader.TryRead<int>(out int intValue));
            ////Assert.Equal(BitConverter.ToInt32(new byte[] { 0, 1, 0, 2 }, 0), intValue);

            Assert.True(reader.TryReadBigEndian(out int intValue));
